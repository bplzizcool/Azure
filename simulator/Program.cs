...
namespace device_simulation
{
    class DeviceSimulation
    {
        ...
        private readonly static string connectionString_Truck = "HostName=BLaneHub.azure-devices.net;DeviceId=TruckDevice;SharedAccessKey=QBQuMAGrF6UjGdiG6BRjM/djWdYbOyqPjW+xYrjdY6c=";
        private readonly static string connectionString_Airplane = "HostName=BLaneHub.azure-devices.net;DeviceId=AirplaneDevice;SharedAccessKey=G6T1jE6jT4T0CZQlPijFjfcBChUaAneN/HbDlY9R5DU=";
        private readonly static string connectionString_Container = "HostName=BLaneHub.azure-devices.net;DeviceId=ContainerDevice;SharedAccessKey=0wlmx4vtTiXEwj+SDu6noWud2tOyj9FPtBbjJRiPTVs=";
